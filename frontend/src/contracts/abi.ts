export const remitEscrowAbi = [
  ...
  { inputs: [], name: 'AlreadyReleased', type: 'error' },
  { inputs: [], name: 'InvalidAmount', type: 'error' },
  { inputs: [], name: 'InvalidFee', type: 'error' },
  { inputs: [], name: 'InvalidPurpose', type: 'error' },
  { inputs: [], name: 'InvalidRecipient', type: 'error' },
  { inputs: [], name: 'NoContributions', type: 'error' },
  ...
  { inputs: [], name: 'RemittanceNotFound', type: 'error' },
  { inputs: [], name: 'TargetNotMet', type: 'error' },
  { inputs: [], name: 'TransferFailed', type: 'error' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'remittanceId', type: 'uint256' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'newPriceFeed', type: 'address' }],
